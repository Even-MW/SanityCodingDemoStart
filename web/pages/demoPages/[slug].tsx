...
export default function DemoPage({ data = {}, preview }: any) {
                ...
                {router.isFallback ? (
                    ...
                    <>
                        <article>
                            ...
                            <Avatar name={demoPage.author.name} picture={demoPage.author.picture} />
                            <b>
                            ...
                            <Image
                                width={2000}
                                height={1000}
                                src={urlForImage(demoPage.poster).height(1000).width(2000).url()}
                            />
